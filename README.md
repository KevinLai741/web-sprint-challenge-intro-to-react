...
React JS is an open-source JavaScript library that is used for building user interfaces. The problems it solves is that it helps offloads a lot of the state that our apps needed to use from the DOM. An example of such is by utilizing the virtual DOM and render certain datas to display in the web browser.

2. Describe component state.

The component state is where the object holds some information that may change over the lifetime of the component.

3. Describe props.

Props, shorthand for properties, are arguments passed into react components or for passing data from one component into another.

4. What are side effects, and how do you sync effects in a React component to changes of certain state or props?

Side effect is anything that affects something outside the scope of the function being executed. You can sync effects in a react component to changes of certain state or props by creating an effect hook. 
